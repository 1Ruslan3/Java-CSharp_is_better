...
public class ImageManager
{
    ...
    /**
     * Команда переворота (Flip).
     */
    static class FlipCommand implements Command
    {
        @Override
        public void execute(File imageFile) throws IOException
        {
            System.out.println("   [Flip] Файл: " + imageFile.getName());
            BufferedImage original = ImageIO.read(imageFile);
            ...
            g.drawImage(original, 0, 0, width, height, width, 0, 0, height, null);
            g.dispose();
